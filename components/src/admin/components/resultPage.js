...
class ResultPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isAuth: null,
      course_list: null,
      student_has_course: null,
      course_has_student: null
    };
  }
  ...
  downloadAffectations = () => {
    ...
    axios
      .get(url + "users/students/get-courses", {
        withCredentials: true,
        headers: { Authorization: "Bearer " + this.state.token }
      })
      .then(
        res => {
          ...
          return (
            <div>
              <CSVDownload data={student_has_course} target="_blank" />
              <CSVDownload data={course_has_student} target="_blank" />
            </div>
          );
        },
        err => {
        ...
        >
          ...
          <form>
            <input
              ...
              value="Génerer les résultats & Télécharger les affectations"
              onClick={() => this.downloadAffectations()}
            />
          </form>
          <br />
          <form>
            <input
              ...
              value="Envoyer les résultats"
              onClick={() => this.sendAffectations()}
            />
          </form>
          <br />
          <form>
